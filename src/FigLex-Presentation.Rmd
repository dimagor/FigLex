...
<h3> The <u>aim</u> of the Figure Lexicon is to identify how these three elements of a visualization contribute to the effective communication of a <u>message</u></h3>  
...
*.. the choice is dependent on the intended message of the figure*
...
##
<h2>The relationship between the carat of a diamond & its price, same plots, more **detail**</h2>  
...
<br>
*What features are **key** to convey the message of this figure?*  
...
* The elements **color, line type, axis labels, figure title and legend** act as <u>guides</u> by directing attention and providing the necessary context of this relationship

# Summary

## 
<h2>Using the Figure Lexicon</h2>
<div align="left">
...
5. Iterate through steps 2-4, each time asking yourself whether your figure effectively communicates the messages in Step 1  
</div>

## FigLex Handout/Cheatsheet
The Figure Lexicon is also available in a convenient one-pager:
https://github.com/dimagor/FigLex/raw/master/src/FigLex-Handout.pdf
